...
def delete_note(requerst, pk = None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            homeworks = Homework(
                ...
                descirption = request.POST['descirption'],
...
def update_home(request,pk = None):
...
def delete_home(request,pk = None):
...
def dictionary(request):
    if request.method == 'POST':
        ...
        try:
            ...
            definition = answer[0]['meanings']['definitions'][0]['definitions']
            example = answer[0]['meanings']['definitions'][0]['example']
            synonyms = answer[0]['meanings']['definitions'][0]['synonyms']
            context={
                'form':form,
                'input':text,
                'phonetics':phonetics,
